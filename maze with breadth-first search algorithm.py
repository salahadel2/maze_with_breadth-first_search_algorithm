...
# print(inital_state, goal_state)


#     def print(self):
#         solution = self.solution[1] if self.solution is not None else None
#         print()
#         for index, value in np.ndenumerate(self.walls):
#             if value:
#                 print("█", end="")
#             elif index == self.inital_state:
#                 print("A", end="")
#             elif index == self.goal_state:
#                 print("B", end="")
#             elif solution is not None and index in solution:
#                 print("*", end="")
#             else:
#                 print(" ", end="")
#         print()
